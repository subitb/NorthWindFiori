...
sap.ui.define([
		...
		"sap/ui/Device",
		"com/mycompany/northwind/FioriNorthwind/model/formatter"
	], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("com.mycompany.northwind.FioriNorthwind.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.mycompany.northwind.FioriNorthwind.view.ViewSettingsDialog", this);
